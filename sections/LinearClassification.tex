...
\begin{figure}[htbp]
    ...
    \caption*{Left: One-versus-the-rest. Right: One-versus-one}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.8]{images/lda_decision_boundaries.png}    \includegraphics[scale=0.5]{images/Multiclass_classification.PNG}
    \caption{Left: One-versus-the-rest. Right: One-versus-one}
\end{figure}
